...
If a character reaches 0 HP without dying instantly, they gain the [[concepts/conditions#Unconscious|Unconscious]] condition and must begin making **Death Saving Throws**.
...
- HP can be restored by magic (spells, potions), or by resting (see [[concepts/resting-and-exhaustion]]).
